...
public class BerbixIDCaptureFragment extends Fragment implements View.OnClickListener {
    ...
    public void refreshStatus() {
        ...
        if (step == Step.FRONT) {
            ...
            if ("pdf417".equals(idStatus.backFormat)) {
    ...
    void submitPhoto() {
        ...
        File scaled = BerbixBitmapUtil.saveToJpg(getActivity(), BerbixBitmapUtil.scaleBitmap(capturedPhoto, 600), "scaled.jpg");
        ...
        if (step == Step.FRONT) {
            ...
            BerbixStateManager.getApiManager().uploadPhotoId(id, "selfie", scaled, null, null);
        } else if (step == Step.LIVENESS) {
            BerbixStateManager.getApiManager().uploadPhotoId(id, "liveness", scaled, null, null);
        }
    }
